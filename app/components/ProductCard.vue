...
<template>
    <article class="group relative overflow-hidden rounded bg-white border border-border transition-all duration-300">
        <div class="relative overflow-hidden bg-gray-50">
            ...
            <button
                ...
                <UIcon name="i-lucide-heart" class="h-4 w-4 text-gray-400 hover:text-red-500" />
            </button>
        ...
        <div class="space-y-2 p-3">
            ...
            <div class="flex items-center gap-2">
                ...
                <span v-if="product.price" class="text-xs text-gray-400 line-through">
                    ৳{{ product.price }}
                </span>

                <span v-if="product.discount_percentage" class="text-xs font-semibold text-red-500">
                    -{{ product.discount_percentage }}%
                </span>
            </div>
