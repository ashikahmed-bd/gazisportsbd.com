...
<template>
  <div class="relative block mb-3">
    ...
    <input :type="type" :placeholder="placeholder" :value="modelValue" :disabled="disabled" @input="updateValue"
      class="w-full px-4 py-2 rounded border border-border focus:border-primary focus:outline-none focus:outline-primary disabled:border-gray-200 disabled:bg-gray-50 disabled:text-gray-500" />
